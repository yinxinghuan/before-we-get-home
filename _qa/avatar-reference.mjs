...
if (testCase === 'direct' || testCase === 'saved-repair') { query.set('avatar_url', avatarUrl); query.set('user_name', 'Generated QA Player') }
...
if (!String(opening.prompt).includes('HARD IDENTITY CAST MAP')) throw new Error('opening omitted the hard identity cast map')
