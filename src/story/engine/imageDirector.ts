...
function buildScenePrompt(
  ...
  return [
    ...
    playerVisible ? `The player protagonist is the dominant visual actor in this frame and must be the same person performing the dominant player action. ${cartridge.playerImageRole ? `Their story role and visual anchor: ${cartridge.playerImageRole}.` : ''} Keep the protagonist's face clearly visible in a natural three-quarter or frontal view; never assign that action to a companion, generic traveler or look-alike.` : '',
