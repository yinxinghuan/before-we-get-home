  ...
  return {
    ...
    opening: {
      ...
      blocks: [
        ...
        { id: 'bh2', kind: 'event', text: s('语音发出于二十三分钟前。你的手机剩余 47% 电量，广场出口有三种离开方式。', 'The message was sent twenty-three minutes ago. Your phone has 47% battery, and the plaza offers three ways out.') },
      ],
      choices: [
