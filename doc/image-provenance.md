...
- 2026-08-11 使用独立生成、非素材库且非真实用户的 1:1 虚构人像与无脸床单鬼头像做过 edit / avatar 对照。两种模式都能独立输出 512×640；头像专用模式仍会把床单鬼重解释成人脸人物，因此剧情继续采用 edit，并使用短、前置的完整视觉身份合同。
- 身份唯一绑定到 `SUBJECT A`，范围不只包含脸，还包含轮廓、形态、遮盖、服装、材质、颜色和配件。阿禾、林岚、小宇、周岚、救援人员、孩子和动物禁止继承或交换任何玩家特征；原头像没有显示的脸、皮肤和手脚也不得凭空出现。
